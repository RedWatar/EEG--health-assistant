...
def submit_question():
    ...
    if not file_path_var.get():
        ...
        try:
            background_prompt = f" Convert the data into beta theta alpha and delta this is the raw output of a EEG sensor(BioAMP EXG pill) and answer the question like a healthcare professional.be short and concise as well. This is the user's data from 5 minutes of EEG recording: {file_name.get()}\n\nData:\n"
